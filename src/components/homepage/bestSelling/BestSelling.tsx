    ...
    <div className="bg-[#382F79]">
      <Container maxW="7xl" w="90%" className="pt-[30px] pb-[50px]">
        <Flex flexDirection="column" gap="20px">
          ...
          <Flex
            width="full"
            className="md:justify-end md:gap-[30px] gap-[10px] justify-start"
          >
            {isSuccess &&
              books
                .slice(0, 3)
          ...
          {(isError || isLoading) && (
            <Flex
              width="full"
              alignItems="center"
              className="md:justify-end md:gap-[30px] gap-[10px] justify-center"
            >
