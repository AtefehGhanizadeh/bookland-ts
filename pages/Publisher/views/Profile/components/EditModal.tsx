...
import ChangePass from "@/pages//Publisher/views/Profile/components/changepass";
...
const EditModal = ({
  ...
  const { mutate, error } = useChangePublisherProfile();
          ...
          <ModalContent>
            ...
            <ModalBody>
              <form className="flex gap-y-[30px]">
                <Flex mr="28px" justifyContent="center" alignItems="center">
