    ...
    >
      <Formik
        ...
        validationSchema={Yup.object({
          oldpass: Yup.string().required("وارد کردن رمز عبور قبلی اجباری است."),
          ...
          <>
            ...
            >
              <ul className="mr-[20px]">
                ...
                {validatePass(formik.values.newpassword)[0].value ? (
                  <li
                    style={{
                      fontSize: "16px",
                      fontWeight: "400",
                ...
                {validatePass(formik.values.newpassword)[3].value ? (
                  <li
                    style={{
                      fontSize: "16px",
                      fontWeight: "400",
                ...
                {validatePass(formik.values.newpassword)[1].value ? (
                  <li
                    style={{
                      fontSize: "16px",
                      fontWeight: "400",
                ...
                {validatePass(formik.values.newpassword)[2].value ? (
                  <li
                    style={{
                      fontSize: "16px",
                      fontWeight: "400",
